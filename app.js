...
const translations = {
  ...
  en: {
    ...
    chatSubjectHintTeacher: "Pick a subject above — messages will be tagged and the feed filtered.",
    chatSubjectHintStudent: "Pick a subject above to filter messages.",
    chatSubjectActiveTeacher: "Writing to subject: {name}. Change above to switch.",
    chatSubjectActiveStudent: "Filter: {name}",
